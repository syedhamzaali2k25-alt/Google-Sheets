import { ACCENT_500, NAVY_950 } from "./theme";
...
export function Logo({ className = "", size = 24 }: { className?: string; size?: number }) {
  ...
  return (
    <span
      className={`inline-flex shrink-0 items-center justify-center rounded-control bg-white shadow-card ${className}`}
      style={{ padding }}
    >
      <svg width={size} height={size} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <rect x="2" y="2" width="28" height="28" rx="7" stroke={NAVY_950} strokeWidth="2.5" />
        <line x1="2" y1="12.5" x2="30" y2="12.5" stroke={NAVY_950} strokeWidth="2" />
        <line x1="13" y1="2" x2="13" y2="30" stroke={NAVY_950} strokeWidth="2" />
        <path
